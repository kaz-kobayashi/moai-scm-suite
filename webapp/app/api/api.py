...
from .endpoints import abc, vrp, inventory, logistics, simple_auth

api_router = APIRouter()
api_router.include_router(simple_auth.router, prefix="/auth", tags=["認証"])
...
public_api_router.include_router(simple_auth.router, prefix="/auth", tags=["認証（公開）"])
